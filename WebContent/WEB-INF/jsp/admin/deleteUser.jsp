            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><spring:message code="menu.userOperations.title"/>/<spring:message code="menu.userOperations.userDelete.title"/></h4>
