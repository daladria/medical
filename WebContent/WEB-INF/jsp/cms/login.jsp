...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/jsLib/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder"><spring:message code="login.title"/></span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2"><spring:message code="login.welcome"/></h4>
              <p class="mb-4"><spring:message code="login.explanation"/></p>
              ...
              <form id="formAuthentication" class="mb-3" action="login" method="POST">
                <div class="mb-3">
                  ...
                  <input
                    ...
                    id="username"
                    name="username"
                    placeholder="<spring:message code="login.userName.hint"/>"
                    autofocus
                  />
                </div>
...
-->
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit"><spring:message code="login.loginButton"/></button>
                </div>
              </form>
<!--  
              <p class="text-center">
...
-->
    ...
    <script src="${pageContext.request.contextPath}/jsLib/assets/vendor/libs/jquery/jquery.js"></script>
    <script src="${pageContext.request.contextPath}/jsLib/assets/vendor/libs/popper/popper.js"></script>
    <script src="${pageContext.request.contextPath}/jsLib/assets/vendor/js/bootstrap.js"></script>
    <script src="${pageContext.request.contextPath}/jsLib/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>

    <script src="${pageContext.request.contextPath}/jsLib/assets/vendor/js/menu.js"></script>
    <!-- endbuild -->

    <!-- Vendors JS -->

    <!-- Main JS -->
    <script src="${pageContext.request.contextPath}/jsLib/assets/js/main.js"></script>
