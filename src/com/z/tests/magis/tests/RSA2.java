...
public class RSA2 {
  public static void main(String[] args) throws Exception {
	...
	try {
		...
		System.out.println("Public:" + java.util.Base64.getEncoder().encodeToString(keyPair.getPublic().getEncoded()));
		System.out.println("Private:" + java.util.Base64.getEncoder().encodeToString(keyPair.getPrivate().getEncoded()));
		...
		cipherPriv.init(Cipher.DECRYPT_MODE,publicKey);
